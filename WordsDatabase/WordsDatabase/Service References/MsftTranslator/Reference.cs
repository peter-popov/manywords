...
namespace WordsDatabase.MsftTranslator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private WordsDatabase.MsftTranslator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public WordsDatabase.MsftTranslator.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="MsftTranslator.LanguageService")]
    public interface LanguageService {
        ...
        WordsDatabase.MsftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, WordsDatabase.MsftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, WordsDatabase.MsftTranslator.Translation[] translations, string from, string to, WordsDatabase.MsftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        WordsDatabase.MsftTranslator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, WordsDatabase.MsftTranslator.TranslateOptions options);
        ...
        WordsDatabase.MsftTranslator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, WordsDatabase.MsftTranslator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : WordsDatabase.MsftTranslator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<WordsDatabase.MsftTranslator.LanguageService>, WordsDatabase.MsftTranslator.LanguageService {
        ...
        public WordsDatabase.MsftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, WordsDatabase.MsftTranslator.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, WordsDatabase.MsftTranslator.Translation[] translations, string from, string to, WordsDatabase.MsftTranslator.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public WordsDatabase.MsftTranslator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, WordsDatabase.MsftTranslator.TranslateOptions options) {
        ...
        public WordsDatabase.MsftTranslator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, WordsDatabase.MsftTranslator.TranslateOptions options) {
